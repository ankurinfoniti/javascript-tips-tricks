import { Tips } from '../model/tips.model';
...
export const tips: Tips[] = [
  {
    ...
    description:
      "Hoisting is JavaScript's default behavior of moving declarations to the top of their scope. While the declarations are hoisted, initializations are not.",
  ...
  },
  {
    ...
    description:
      'A closure is the combination of a function and the lexical environment within which that function was declared. This lets the function access variables in its outer scope.',
  ...
  },
  {
    ...
    description:
      'Arrow functions provide a concise syntax for writing function expressions. They also lexically bind the this value, making them ideal for callbacks.',
  ...
  },
  {
    ...
    description:
      'The spread operator (...) allows an array or object to be expanded into individual elements, making it perfect for array manipulation and object merging.',
  ...
  },
  {
    ...
    description:
      'Optional chaining (?.) allows you to safely access deeply nested object properties without worrying about null or undefined values.',
  ...
  },
  {
    ...
    description:
      'Template literals allow you to create multiline strings and use string interpolation with ${expression} syntax.',
  ...
  },
  {
    ...
    description:
      'Modern JavaScript provides powerful array methods like map, filter, and reduce for data transformation and manipulation.',
  ...
  },
  {
    ...
    description:
      'JavaScript offers various methods to work with objects, including Object.keys(), Object.values(), and Object.entries().',
    codeSnippet: `const person = { name: 'John', age: 30 };
  ...
  },
  {
    ...
    description:
      'Sets are collections of unique values that provide an elegant way to remove duplicates and manage unique items.',
  ...
  },
  {
    ...
    description:
      'Maps provide a way to store key-value pairs where both keys and values can be of any type, unlike regular objects.',
  ...
  },
  {
    ...
    description:
      'Generator functions provide a powerful way to define iterative algorithms by maintaining their own state.',
  ...
  },
  {
    ...
    description:
      'Proxies enable you to create custom behaviors for basic object operations like property lookup, assignment, and enumeration.',
  ...
  },
  {
    ...
    description:
      'Decorators provide a way to add both annotations and meta-programming syntax to class declarations and members.',
  ...
  },
  {
    ...
    description:
      'ES Modules provide a standard way to organize and share code between JavaScript files.',
    codeSnippet: `// math.js
  ...
  },
  {
    ...
    description:
      'Regular expressions provide a powerful way to perform pattern matching and text manipulation in strings.',
  ...
  },
  {
    ...
    description:
      'Modern browsers provide powerful APIs for features like storage, geolocation, and real-time communications.',
  ...
  },
  {
    ...
    description:
      'Promise chaining allows you to perform sequential asynchronous operations while keeping the code clean and avoiding callback hell.',
  ...
  },
  {
    ...
    description:
      'The iterator protocol allows you to define how an object should be iterated, enabling custom iteration behavior.',
  ...
  },
  {
    ...
    description:
      'WeakMap holds weak references to key objects, allowing them to be garbage collected when no longer referenced elsewhere.',
  ...
  },
  {
    ...
    description:
      "WeakSet lets you store weak object references that don't prevent garbage collection of their elements.",
    codeSnippet: `let obj = { data: 'value' };
  ...
  },
  {
    ...
    description:
      'Typed arrays provide a mechanism for accessing raw binary data in a structured way.',
  ...
  },
  {
    ...
    description:
      'The Reflection API provides methods for interceptable JavaScript operations, useful for metaprogramming.',
  ...
  },
  {
    ...
    description:
      'BigInt allows you to work with integers larger than 2^53, which is the largest number JavaScript can reliably represent with Number.',
  ...
  },
  {
    ...
    description:
      'Private class fields allow you to define class members that are only accessible within the class itself.',
  ...
  },
  {
    ...
    description:
      'The Performance API provides access to timing-related information for the current page.',
  ...
  },
  {
    ...
    description:
      'Web Workers allow you to run scripts in background threads, enabling parallel processing without blocking the main thread.',
  ...
  },
  {
    ...
    description:
      'The Intersection Observer API provides a way to detect when elements enter or leave the viewport.',
  ...
  },
  {
    ...
    description:
      'MutationObserver lets you watch for changes being made to the DOM tree.',
  ...
  },
  {
    ...
    description:
      'BroadcastChannel API allows communication between different tabs, windows, and iframes of the same origin.',
  ...
  },
  {
    ...
    description:
      'ResizeObserver provides a way to react to changes in element dimensions.',
  ...
  },
  {
    ...
    description:
      'The Web Animations API provides control over browser animations through JavaScript.',
  ...
  },
  {
    ...
    description:
      'The Credential Management API enables websites to interact with user credentials.',
  ...
  },
  {
    ...
    description:
      'The Payment Request API provides a consistent way to handle payments across different browsers.',
  ...
  },
  {
    ...
    description:
      "The Web Share API enables websites to use the platform's native sharing capabilities.",
  ...
  },
  {
    ...
    description:
      'The MediaRecorder API enables recording of audio and video streams.',
  ...
  },
  {
    ...
    description:
      "The Media Capabilities API provides information about the device's ability to play media.",
  ...
  },
  {
    ...
    description:
      'The Web Locks API allows web apps to coordinate access to resources.',
  ...
  },
  {
    ...
    description:
      'Background Fetch API allows downloading of large resources in the background.',
  ...
  },
  {
    ...
    description:
      'The ImageCapture API provides advanced camera controls for web applications.',
    codeSnippet: `navigator.mediaDevices.getUserMedia({ video: true })
    .then(stream => {
  ...
  },
  {
    ...
    description:
      "The Contact Picker API allows web apps to access the device's contacts.",
  ...
  },
  {
    ...
    description:
      'Web NFC enables web applications to read and write NFC tags when they are in close proximity.',
  ...
  },
  {
    ...
    description:
      'The Web USB API provides a way to safely connect to USB devices from web applications.',
  ...
  },
  {
    ...
    description:
      'The Web Serial API provides a way to read and write data to serial devices connected to your computer.',
  ...
  },
  {
    ...
    description:
      'The Web Speech API enables web apps to handle voice data, including speech recognition and synthesis.',
  ...
  },
  {
    ...
    description:
      'The Web Crypto API provides cryptographic functionality in web applications.',
  ...
  },
  {
    ...
    description:
      'WebTransport provides modern networking capabilities with multiple streams and low latency.',
  ...
  },
  {
    ...
    description:
      'WebCodecs provides low-level access to media encoders and decoders.',
  ...
  },
  {
    ...
    description:
      'The WebHID API allows web apps to interact with Human Interface Devices (HID).',
  ...
  },
  {
    ...
    description:
      'WebGPU provides modern graphics and compute capabilities for web applications.',
  ...
  },
  {
    ...
    description:
      'The Web Neural Network API enables running machine learning models in the browser.',
  ...
  },
  {
    ...
    description:
      'WebAssembly enables running low-level code at near-native speed in web browsers.',
  ...
  },
  {
    ...
    description:
      'The Web Bluetooth API provides a way to connect and interact with Bluetooth Low Energy devices.',
  ...
  },
  {
    ...
    description:
      'WebGL 2 provides advanced 3D graphics capabilities in the browser.',
  ...
  },
  {
    ...
    description:
      'WebSocket enables two-way communication between a client and server over a single connection.',
  ...
  },
  {
    ...
    description:
      'The Notifications API enables web apps to display system notifications to the user.',
  ...
  },
  {
    ...
    description:
      'The Payment Request API standardizes the payment checkout process in web applications.',
    codeSnippet: `const request = new PaymentRequest(
    [{ supportedMethods: 'basic-card' }],
    { total: { label: 'Total', amount: { currency: 'USD', value: '10.00' }}}
  );`,
  },
  {
    ...
    description:
      'The Web MIDI API enables web applications to interact with MIDI musical instruments.',
  ...
  },
  {
    ...
    description:
      'The Web Authentication API enables strong authentication with public key cryptography.',
